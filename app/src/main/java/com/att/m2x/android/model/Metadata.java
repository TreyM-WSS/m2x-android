...
import com.att.m2x.android.services.CollectionService;
import com.att.m2x.android.services.DeviceService;
import com.att.m2x.android.services.DistributionService;
 ...
 * Metadata Class
 *
 * @deprecated Replaced by methods in {@link DeviceService}, {@link DistributionService}, and {@link CollectionService}
 */
@Deprecated
public class Metadata {
     ...
     * {@link DistributionService#readDistributionMetadata(Context, Distribution, TypedResponseListener)},
     * {@link CollectionService#readCollectionMetadata(Context, Collection, TypedResponseListener)}
     *
     ...
     */
    public static void metadata(Context context, String path, ResponseListener listener, int requestCode) {
     ...
     * {@link DistributionService#updateDistributionMetadata(Context, Distribution, TypedResponseListener)},
     * {@link CollectionService#updateCollectionMetadata(Context, Collection, TypedResponseListener)}
     *
     ...
     */
    public static void updateMetadata(Context context, String path, JSONObject body, ResponseListener listener, int requestCode) {
     ...
     * {@link DistributionService#readDistributionMetadataField(Context, Distribution, String, TypedResponseListener)},
     * {@link CollectionService#readCollectionMetadataField(Context, Collection, String, TypedResponseListener)}
     *
     ...
     */
    public static void metadataField(Context context, String path, ResponseListener listener, int requestCode) {
        JsonRequest.makeGetRequest(context, path, null, listener, requestCode);
    }

    /**
     * @deprecated Replaced by {@link DeviceService#updateDeviceMetadataField(Context, Device, String, String, TypedResponseListener)},
     * {@link DistributionService#updateDistributionMetadataField(Context, Distribution, String, String, TypedResponseListener)},
     * {@link CollectionService#updateCollectionMetadataField(Context, Collection, String, String, TypedResponseListener)}
     *
     * Update the custom metadata of the specified entity.
     *
     * @param body parameters for the request as JSON object
     ...
     */
    public static void updateMetadataField(Context context, String path, JSONObject body, ResponseListener listener, int requestCode) {
        JsonRequest.makePutRequest(context, path, body, listener, requestCode);
    }
